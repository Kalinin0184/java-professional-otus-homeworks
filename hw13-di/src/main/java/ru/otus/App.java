...
public class App {
    ...
    public static void main(String[] args) throws Exception {
        ...
        //        ru.otus.config.modular.AppConfig1.class,
        //        ru.otus.config.modular.AppConfig2.class);
        //AppComponentsContainer container = new AppComponentsContainerImpl("ru.otus.config.modular");
